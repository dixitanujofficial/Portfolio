        ...
        <div className="order-2 lg:order-1">
          ...
          <Reveal delay={200}>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl">
              BS Data Science at IIT Madras with a complementary BCA at K.P.B.
              Hinduja College. Specializing in MERN Stack development and
              exploring AI technologies to build innovative, high-performance
              applications.
            </p>
          </Reveal>
